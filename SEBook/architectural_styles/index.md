...
### Data Flow Styles: Pipes and Filters
...
*   **Layered Architecture:** The system is partitioned into horizontal groupings of modules (layers) organized by abstraction. The strict constraint of this style is the *allowed-to-use* relation: a layer may only use the services of the layer immediately below it. By acting as a "virtual machine" to the layer above it, this style isolates changes, promoting profound *portability* and *modifiability*.
...
### Implicit Invocation: Publish-Subscribe and Event-Based
