...
## 1.1 The Essence of Software Architecture
...
## 1.2 The Dichotomy of Architecture
...
A common misperception among novices is that the visual diagrams and documentation *are* the architecture. The literature firmly refutes this: representations are merely pictures, whereas the *real* architecture consists of the actual structures present in the implemented source code (Eeles & Cripps 2009),.
