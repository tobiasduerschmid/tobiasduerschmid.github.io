...
A recurring debate within the literature is the precise boundary between *architecture* and *design*. Grady Booch famously noted, "All architecture is design, but not all design is architecture" {% cite Booch1999 %}. However, the industry has historically struggled to define where architecture ends and design begins, often relying on the flawed concept of "detailed design". 
